...
?>
					...
					<td class="col-md-2 close-btn">
						<a href="my-wishlist.php?del=<?php echo htmlentities($row['wid']);?>" onClick="return confirm('Are you sure you want to delete?')" class="btn-upper btn btn-primary">delete</a>
					</td>
				</tr>
				<?php } } else{ ?>
				<tr>
