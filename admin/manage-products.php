...
<?php include('include/sidebar.php');?>				
	...
	<div class="module">
							<div class="module-head">
								<h3 style="background-color:lightblue; color:black; font-weight:bold">Manage Products</h3>
							</div>
...
?>									
										<tr>
											...
											<td>
											<a href="products.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')">
											<div class="delete">
