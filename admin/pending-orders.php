...
if (isset($_POST['submit'])) {
  ...
  $reversonQury="insert into reservation(order_id,del_id,res_date,del_date) values($order_id,$user_id_deliveryboy,'$admremarkdate','$admremarkdate')";
	...
	if (mysqli_query($con,$reversonQury ))
          {
...
?>										
										<tr>
											...
											<td>
												...
												<?php } else{?>
											<a href="assignDeliveryBoy.php?orderId=<?php echo $row['id'];?>" class="waves-effect waves-light btn blue m-b-xs"  > Assign</a>
											<!-- <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal">Assign</button> -->
											<?php	}?>
