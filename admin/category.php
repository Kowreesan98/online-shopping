					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3 style="background-color:lightblue; color:black; font-weight:bold">Category</h3>
							</div>
...
{?>
									<div class="alert alert-success">
										<button type="button" class="close" data-dismiss="alert">successfully created</button>
...
<div class="control-group">
	...
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn" style="background-color:blue; color: white">Create</button>
											</div>
										</div>
									</form>
							</div>
	...
	<div class="module">
							<div class="module-head">
								<h3 style="background-color:lightblue; color:black; font-weight:bold">Manage Categories</h3>
							</div>
