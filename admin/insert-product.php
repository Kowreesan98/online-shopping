...
$sql=mysqli_query($con,"insert into products(category,subCategory,productName,productCompany,productPrice,shippingCharge,productAvailability,productImage,productPriceBeforeDiscount) values('$category','$subcat','$productname','$productcompany','$productprice','$productscharge','$productavailability','$productimage','$productpricebd')");
...
<input type="file" name="productimage" id="productimage1" value="" class="span8 tip" required>
	...
	<div class="control-group">
											<div class="controls">
												<button type="submit" name="submit" class="btn" style="background-color:blue;color:white">Insert</button>
											</div>
										</div>
									</form>
							</div>
