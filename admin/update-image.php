...
//unlink($dir.'/'.$pimage);
	...
	move_uploaded_file($_FILES["productimage"]["tmp_name"],"productimages/$pid/".$_FILES["productimage"]["name"]);
...
{?>
									...
									<strong>successfully updated</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage']);?>" width="200" height="100"> 
</div>
</div>
