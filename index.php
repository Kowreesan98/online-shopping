		...
		<div class="row">
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">dedicated 24/7 service </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
?>
		...
		-->
		<div class="image">
		<img src = "https://image.freepik.com/free-vector/stay-safe-banner-with-hand-sanitizer-medical-protective-mask_1268-15169.jpg" width="1000" height="400" >
